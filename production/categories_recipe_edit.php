...
?>
                          <tr>
                            <td class="h6"><?=$cate["Recipe_cate_ID"]?></td>
                            <td class="h6"><?=$cate["Recipe_cate_name"]?></td>
                            <td class="h6"><?=$cate["R_Description"]?></td>
                            <td>
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <div class="modal-body">
                  <form id="editCategoryForm" method="POST" action="do_edit_recipe.php">
                    <input type="hidden" name="id" id="id" value="<?php echo $rows[0]["Recipe_cate_ID"]; ?>">
                    <div class="form-group">
                      <label for="categoryName">分類名稱</label>
                      <input type="text" class="form-control" id="categoryName" name="categoryName" value="<?php echo $rows[0]["Recipe_cate_name"]; ?>">
                    </div>
                    <div class="form-group">
                      <label for="categoryDescription">分類描述</label>
                      <textarea class="form-control" id="categoryDescription" name="categoryDescription"><?=htmlspecialchars($rows["R_Description"])?></textarea>
                    </div>
                  </form>
                </div>
