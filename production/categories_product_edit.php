                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex justify-content-between">
                                ...
                                <a href="#" class="btn btn-danger border-0 remove-btn" data-bs-toggle="modal" data-bs-target="#removeModal" data-id="<?=$cate["Product_cate_ID"]?>" onclick="setDeleteId(this)"><i class="fa-solid fa-trash fa-fw"></i></a>
                              </div>
                            </td>
                          </tr>
                          <?php endforeach;?>
