...
if (isset($_GET["Class_ID"])) {
  ...
  $whereClause = "WHERE F_Class_ID = '$Class_ID'";
} else {
  $whereClause = "";
  die("請循正常管道進入此課程頁面");
}
...
//join class and image
$sqlImage = "SELECT class.*, class_image.F_Class_ID
FROM class
JOIN class_image ON class.Class_ID =  class_image.F_Class_ID
$whereClause";
$resultImage = $conn->query($sqlImage);
$rowsImage = $resultImage->fetch_all(MYSQLI_ASSOC);
$rowsImageCount = $resultImage->num_rows;
?>
